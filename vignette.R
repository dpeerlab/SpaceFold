#test projected axis concordance
detach("package:SpaceFold",unload=TRUE)
library(SpaceFold)
...
group.list <- list("Lgr5+ stem"="Lgr5+ stem",
					"Lgr5+ progenitor"="Lgr5+ progenitor",
					"TA"="TA",
					paneth="paneth",
					enterocytes=c("bottom zone enterocyte","mid zone enterocyte","top zone enterocyte"),
